#
# Be sure to run `pod lib lint CLIPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CLIPlayer'
  s.version          = '0.1.0'
  s.summary          = 'Video Player for CLI Studios.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
TODO: Video Player for CLI Studios.
                       DESC

  s.homepage         = 'https://github.com/buubui/CLIPlayer'
